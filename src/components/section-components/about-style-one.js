...
class AboutStyleOne extends Component {
    ...
    render() {
        ...
        return (
            <section className="about-one go-top" data-aos="fade-in">
                    ...
                    <div className="row justify-content-end">
                        <div className="col-lg-6">
                            <div className="about-one__content">
                                <div className="block-title text-left" data-aos="fade-up">
                                    <p><span>About Us</span></p>
                                    <h3>What makes <br /> our creative <br /> Digital Agency  <br /> Your Ideal Partner</h3>
                                    <div className="block-title__line" />{/* /.block-title__line */}
                                </div>{/* /.block-title */}
                                <p data-aos="fade-up" data-aos-delay="300">Your brand's vision is brought to life with a blend of creativity
                                ...
                                <h4 data-aos="fade-up" data-aos-delay="500">Driving promising results &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  24/7 Support 
                                    <br/> Professional Staff &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Fair Prices</h4>
                                <Link to="/about" className="thm-btn about-one__btn" data-aos="fade-up" data-aos-delay="700">Read More <i className="fa fa-angle-double-right" /></Link>
                                {/* /.thm-btn */}
