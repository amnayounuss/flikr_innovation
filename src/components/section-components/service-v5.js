		            ...
		            <div className="col-md-6">
		              <div className="service-two__single js-tilt">
		                ...
		                <div className="service-two__single-inner">
		                  ...
		                  <h3><Link to="/service-details">Website Development</Link></h3>
		            ...
		            <div className="col-md-6">
		              <div className="service-two__single js-tilt">
		                ...
		                <div className="service-two__single-inner">
		                  ...
		                  <h3><Link to="/service-details">Mobile App Development</Link></h3>
		            ...
		            <div className="col-md-6">
		              <div className="service-two__single js-tilt">
		                ...
		                <div className="service-two__single-inner">
		                  ...
		                  <h3><Link to="/service-details">Graphic Designing</Link></h3>
					...
					<div className="col-md-6">
		              <div className="service-two__single js-tilt">
		                ...
		                <div className="service-two__single-inner">
		                  ...
		                  <h3><Link to="/service-details">E-Book</Link></h3>
		            ...
		            <div className="col-md-6">
		              <div className="service-two__single js-tilt">
		                ...
		                <div className="service-two__single-inner">
		                  ...
		                  <h3><Link to="/service-details">SEO</Link></h3>
